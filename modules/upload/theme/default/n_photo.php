...
function insertPhoto()
{
	...
	<?php if($gparamExp[0]):?>
	if(opener.parent.getId('<?php echo $gparamExp[0]?>'))
	{
		opener.parent.getId('<?php echo $gparamExp[0]?>').value = opener.parent.getId('<?php echo $gparamExp[0]?>').value + upfiles;
	}
	<?php endif?>
	<?php if($gparamExp[1]):?>
	if(opener.parent.getId('<?php echo $gparamExp[1]?>'))
	{
		opener.parent.frames.<?php echo $gparamExp[1]?>.location.href = opener.parent.frames.<?php echo $gparamExp[1]?>.location.href + upfiles;
	}
	<?php endif?>
	<?php if($gparamExp[2]):?>
	if(opener.parent.frames[0])
	{
		opener.parent.SetEditor("<?=$gparamExp[3]?>",photos);
	}
	<?php endif?>
