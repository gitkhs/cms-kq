...
<link type="text/css" rel="stylesheet" charset="utf-8" href="<?php echo $g['s']?>/_core/css/glyphicon.css<?php echo $g['wcache']?>" />
...
<script type="text/javascript" charset="utf-8" src="<?php echo $g['s']?>/_core/js/jquery-1.11.1.min.js"></script>
