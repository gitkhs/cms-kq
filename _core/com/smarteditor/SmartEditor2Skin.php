			...
			<ul class="se2_font_type">
				...
				<ul class="se2_multy">
					...
					<li class="se2_mn husky_seditor_ui_photo_attach">
						<button type="button" class="se2_photo se2_wty2_ic se2_mfirst" onclick="window.open('<?=$_GET['s']?>/?r=<?=$_GET['r']?>&m=upload&mod=n_photo&gparam=upfilesValue|upfilesFrame|editFrame|<?=$_GET['id']?>','','left=0,top=0,width=100px,height=100px,statusbar=no,scrollbars=no,toolbar=no');">
							<span class="se2_icon"></span>
							<span class="se2_mntxt">사진<span class="se2_new"></span></span>
						</button>
					</li>
					<?}?>
					<?if($_GET['s_file']){?>
					<li class="se2_mn husky_seditor_ui_photo_attach">
						<button type="button" class="se2_file se2_wty2_ic se2_mfirst" onclick="window.open('<?=$_GET['s']?>/?r=<?=$_GET['r']?>&m=upload&mod=n_file&gparam=upfilesValue|upfilesFrame','','left=0,top=0,width=100px,height=100px,statusbar=no,scrollbars=no,toolbar=no');">
							<span class="se2_icon_file"></span>
							<span class="se2_mntxt">파일<span class="se2_new"></span></span>
						</button>
					</li>
					<?}?>
<!--
<li class="se2_mn husky_seditor_ui_file_attach">
	<button type="button" class="se2_file se2_wty2_ic se2_mfirst" onclick="window.open('../../../../../../?m=upload&mod=n_file&gparam=upfilesValue|upfilesFrame','','left=0,top=0,width=100px,height=100px,statusbar=no,scrollbars=no,toolbar=no');">
		<span class="se2_icon"></span>
		<span class="se2_mntxt">파일<span class="se2_new"></span></span>
	</button>
</li>
